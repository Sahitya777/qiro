                ...
                <Box display="flex" justifyContent="space-between" mt="2rem" gap="2rem">
                    <Box display="flex" flexDirection="column" mt="2rem">
                        ...
                        <Box display="flex" mt="1rem" gap="1rem">
                            ...
                            <Box filter="drop-shadow(12px 12px 32px #2E334E)" width="222px" display="flex" gap="8" borderRadius="16px" boxShadow="2px 2px 4px 0px rgba(38, 49, 105, 0.16) inset" border="1px solid #424869" padding="9px 12px 9px 16px" background=" linear-gradient(135deg, #495076 0%, #424869 100%)" >
                                <Text fontSize="24px" fontWeight="400" color="#D2D6EF">
                                    1000.0
                                </Text>
                            </Box>
                            <Box mt="0.8rem" ml="1rem">
                                <Image
                                    src={arrow}
                                    alt=""
                                />
                        ...
                        <Box mt="3rem" width="92%" borderBottom="1px solid #5A6086">
                        </Box>
                        <Box display="flex" mt="2rem" justifyContent="space-between" width="70%">
                            <Box>
                                ...
                                <Text mt="0.5rem" color="#23BE4F" fontSize="18px" fontWeight="400" lineHeight="22px" letterSpacing="0.9px">
                                    55.3%
                                </Text>
                            </Box>
                            <Box>
                                ...
                                <Text mt="0.5rem" color="#D2D6EF" fontSize="18px" fontWeight="400" lineHeight="22px" letterSpacing="0.9px">
                                    $24.1M
                                </Text>
                            </Box>
                        </Box>
                            ...
                            <Box>
                                ...
                                <Box display="flex" gap="0.5rem" mt="1rem">
                                    ...
                                    <Text width="350px" mt="0.2rem" color="#D2D6EF" fontSize="14px" fontWeight="400" lineHeight="20px" letterSpacing="0.6px">
                                        Use your low-volatility assets (stable coins) to get exposure to <br/> high-volatility assets.
                                    </Text>
                                </Box>
                                <Box display="flex" gap="0.5rem" mt="0.8rem">
                                    <Image
                                        src={tickIcon}
                                        style={{ marginTop: "0.5rem" }}
                                        alt=""
                                    />
                                    <Text mt="0.2rem" width="360px" color="#D2D6EF" fontSize="14px" fontWeight="400" lineHeight="20px" letterSpacing="0.6px">
                    ...
                    <Box filter="drop-shadow(12px 12px 32px #2E334E);" boxShadow="2px 2px 2px 0px rgba(83, 92, 136, 0.11) inset;" width="500px" display="flex" flexDirection="column" padding="32px" borderRadius="12px" background="linear-gradient(119deg, #464C6E 0%, #272B45 100%);">
                        <Box display="flex" justifyContent="space-between" >
                            <Text fontSize="18px" fontWeight="400" lineHeight="20px" letterSpacing="1px" mt="0.3rem">
                                Projected returns
                            </Text>
                            <Box display="flex">
                                <input type="checkbox" id="toggle" className="toggleCheckbox" checked />
                        ...
                        <Box mt="1.5rem">
                            <Text display="flex" color="#D2D6EF" fontSize="36px" fontWeight="400" lineHeight="42px" letterSpacing="-0.5px">
                                <Image
                                    ...
                                    height={32}
                                    width={32}
                                    style={{ marginTop: "0.3rem", marginRight: "0.8rem" }}
                                    alt=""
                                />
                                +0.216 ETH
                            </Text>
                            ...
                            <Box>
                                ...
                                <Box mt="1rem" display="flex" gap="0.5rem">
                                    <Box>
                                        ...
                                        <Box color="rgba(210, 214, 239, 0.30)" fontSize="14px" fontWeight="400" lineHeight="18px" letterSpacing="0.5px"  mt="0.4rem">
                                            ETHALend
                                        </Box>
                                    </Box>
                                    <Box>
